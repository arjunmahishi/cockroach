...
import overviewGeneratedDashboard from "./dashboards/overview_generated";
...
// TODO(arjunmahishi): this also should be autogenerated
const dashboards: { [key: string]: GraphDashboard } = {
  ...
  "overview-generated": {
    ...
    component: overviewGeneratedDashboard,
    isKvDashboard: false,
  },
  hardware: {
    label: "Hardware",
